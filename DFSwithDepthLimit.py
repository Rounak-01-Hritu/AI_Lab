...
def DFS(start, x, y, depth_limit=200):
    stack = []
    visited = set()
    ...
    while stack:
        ...
        # ❗ Terminate if depth exceeds limit
        if current.depth > depth_limit:
            print(f"❌ Depth limit exceeded ({depth_limit}). Search terminated.")
            return
        ...
        for i in range(4):
            ...
            if is_valid(new_x, new_y):
                ...
                if board_tuple not in visited:
                    ...
                    stack.append(P8Board(new_board, new_x, new_y, current.depth + 1))
